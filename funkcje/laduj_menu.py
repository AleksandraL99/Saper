...
def laduj_menu(window):
    dane = klasy.Dane.Dane()  # startowa szerokość planszy
    ...
    label = tkinter.Label(menu, text="Wybierz wielkość pola",
                          bg=funkcje.stale.SZARY_CIEMNY, width=SZEROKOŚĆ, height=WYSOKOŚĆ)
    ...
    przycisk_dalej = tkinter.Button(menu, bg=funkcje.stale.SZARY_JASNY, width=10, heigh=WYSOKOŚĆ,
                                    command=lambda: funkcje.faza_pierwsza.faza_pierwsza
